    ...
    <label>First Name:</label>
       ...
       <option value="1990"<?php if ($year=='1990') echo "selected"?>>1990</option>
        ...
        <select name="favourite_food">
            <option <?php if($row['favourite_food']=='fish_curry') echo 'selected';?> value="fish curry">Fish curry</option>
            <option <?php if($row['favourite_food']=='barger') echo 'selected';?> value="barger">Cheas Barger</option>
            <option <?php if($row['favourite_food']=='rice') echo 'selected';?> value="Chicken fried rice">Chicken fried rice</option>
